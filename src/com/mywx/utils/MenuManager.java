...
import com.mywx.menu.*;
import com.mywx.pojo.AccessToken;

/**
 * Created by wangzy on 2017/6/2.创建主菜单
 */
public class MenuManager {

    public static void main(String[] args) {
        // 第三方用户唯一凭证
        String appId = "wxa8f4325fb8e78f07";
        // 第三方用户唯一凭证密钥
        String appSecret = "bd289e2ee6e4b8790277a58572866d42";
